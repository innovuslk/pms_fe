        ...
        const setTimeRanges = (shift) => {
            if (shift === 'A') {
                ...
                return [
                    ...
                    { startHour: 10, startMinute: 30, endHour: 11, endMinute: 30, label: '4th Hour', hourValue: 4 },
                    ...
                    { startHour: 15, startMinute: 0, endHour: 16, endMinute: 0, label: '8th Hour', hourValue: 8 },
                    { startHour: 16, startMinute: 0, endHour: 17, endMinute: 0, label: '9th Hour', hourValue: 9 },
                    { startHour: 17, startMinute: 0, endHour: 18, endMinute: 30, label: '10th Hour', hourValue: 10 },
                ];
            } 
            else {
                return [];
