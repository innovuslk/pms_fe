                    ...
                    <div className="card">
                        <div className="card-body p-4">
                            ...
                            <form className="row g-3" onSubmit={handleSubmit}>
                                ...
                                {UserLevel === '2' ? <div className="col-md-12">
                                    <label for="input32" className="form-label">Mobile Number (for supervisors)</label>
                                    <div className="input-group">
                                        <span className="input-group-text"><span class="material-symbols-outlined">
                                            phone
                                        </span></span>
                                        <input type="text" className="form-control" id="input32" placeholder="Mobile Number" validate={{ required: true }} onChange={e => setMobile(e.target.value)} />
                                    </div>
                                </div> : ''}
                                <div className="col-md-12">
